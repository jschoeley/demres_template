...
\newcommand{\biburl}[1]{\href{#1}{\textcolor{blue}{#1}}}
...
\fancypagestyle{regular}{
  ...
  \fancyfoot[LO,RE]{\drfootersize\href{http://www.demographic-research.org}{http://www.demographic-research.org}}
}
...
\newcommand{\makecover}{\begin{titlepage}%
  ...
  \begin{tabular}{p{8.5cm}}
    ...
    \fontfamily{ptm}\selectfont\normalsize{\href{http://www.demographic-research.org/Volumes/Vol85}{http://www.demographic-research.org/Volumes/Vol\thevolume/\thearticle/}}\\
...
% add appendices
 ...
 \fi
  ...
  \NormalTok{    )}
    ...
    \KeywordTok{return}\NormalTok{(lt)}
